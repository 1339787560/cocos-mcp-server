...
class ComponentTools {
    ...
    async addComponent(nodeUuid, componentType) {
        return new Promise(async (resolve) => {
            ...
            try {
                const result = await (0, compat_1.createComponentWithFallback)(nodeUuid, componentType);
                // 等待一段时间让Editor完成组件添加
    ...
    async attachScript(nodeUuid, scriptPath) {
        return new Promise(async (resolve) => {
            ...
            (0, compat_1.createComponentWithFallback)(nodeUuid, scriptName).then(async (result) => {
                var _a;
                // 等待一段时间让Editor完成组件添加
                await new Promise(resolve => setTimeout(resolve, 100));
